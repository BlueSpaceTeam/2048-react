 ...
 * @LastEditTime: 2022-06-30 17:11:28
 * @LastEditors: tim.wen
 * @Description:
 * @FilePath: /2048-react/react/src/utils/constants.ts
 */

// 判断不同设备移动触发游戏方块的最小值
export const MIN_DISTANCE_PC = 100;
export const MIN_DISTANCE_M = 30;

// 方块Row*Col矩阵常量
export const MATRIX_ROW = 4;
export const MATRIX_COL = 4;
